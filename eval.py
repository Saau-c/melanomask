...
if __name__ == '__main__':
    ...
    def evaluate(
        ...
        all_preds = np.concatenate([preds_dict['labels'] for preds_dict in preds])
        all_targets = np.concatenate([true_dict['labels'] for true_dict in target])
        ...
        metric_summary['f1_score'] = f1
        metric_summary['confusion_matrix'] = confusion_mat
